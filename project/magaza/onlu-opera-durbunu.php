...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from obje where id=2", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje2.webp" alt="10’lu Opera Dürbünü Seti">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje2.webp" alt="10’lu Opera Dürbünü Seti"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">10’lu Opera Dürbünü Seti</span>
          <span class="product-price" style="margin-top:40px">8000 &#8378;</span>
          <p class="product-description">Sedef & pirinç opera dürbünleri.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Bir zamanlar operalarda</strong>
                seyircilerin sahneyi daha iyi görmesi için kiralanan opera dürbünleri. Fransız ve Rus menşeili. Kadife perdeler, kabarık etekler, beyaz eldivenlerle dolu salonları hayal etmek için.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 6×9 ve 6×4 boyutunda farklı adetlerde. (Toplam 10 adet)</p>
          <p class="product-description" style="margin-top:-10px;">– Pirinç & sedef.</p>
