      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/ipek-kemer.jpg" alt="İpek Kemer">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/ipek-kemer.jpg" alt="İpek Kemer"></div>
            <div><img src="image/urunler/ipek-kemer2.jpg" alt="İpek Kemer"></div>
            <div><img src="image/urunler/ipek-kemer3.jpg" alt="İpek Kemer"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">İpek Kemer</span>
          <span class="product-price" style="margin-top:40px">400 &#8378;</span>
          <p class="product-description">İpek saten kemer.</p>
