...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from obje where id=7", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje7.webp" alt="Christofle Kase">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje7.webp" alt="Christofle Kase"></div>
            <div><img src="image/urunler/christofle-kase-2.jpg" alt="Christofle Kase"></div>
            <div><img src="image/urunler/christofle-kase-3.jpg" alt="Christofle Kase"></div>
            <div><img src="image/urunler/christofle-kase-4.jpg" alt="Christofle Kase"></div>
            <div><img src="image/urunler/christofle-kase-5.jpg" alt="Christofle Kase"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Christofle Kase</span>
          <span class="product-price" style="margin-top:40px">1600 &#8378;</span>
          <p class="product-description">Gümüş kaplama kase.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">1830’da Paris’te</strong> kurulmuş ünlü Christofle markalı kase. Gümüş kaplamanın mucidi sayılan bu prestijli markanın en özel ürünlerinden biri. Çok zarif, çok nadide.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 7.5.5×18.5cm</p>
