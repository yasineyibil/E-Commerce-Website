  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "Gümüş Kaplama Yumurta Servisi";
  ...
  <div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
    ...
    $products = $db->query("SELECT * from mutfakk where id=2", PDO::FETCH_OBJ)->fetchAll();
        ...
        <div class="product-div">
          <div class="product-div-left">
            <div class="img-container">
              <img src="image/urunler/gumus-yumurta-servis.jpg" alt="Gümüş Kaplama Yumurta Servisi">
            </div>
            <div class="hover-container">
              <div><img src="image/urunler/gumus-yumurta-servis.jpg" alt="Gümüş Kaplama Yumurta Servisi"></div>
            </div>
          </div>
          <div class="product-div-right">
            <span class="product-name">Gümüş Kaplama Yumurta Servisi</span>
            <span class="product-price" style="margin-top:40px">5000 &#8378;</span>
            <p class="product-description">Gümüş kaplama 4lü yumurta servis seti.</p>
            ...
            <div class="sag-sol">
              ...
              <div class="sag">
                <p>
                  <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Victoria döneminden</strong> kalma, gerçek bir zarafet timsali bir parça. İşçiliği, malzemesi, detaylarıyla enfes.
                </p>
              </div>
            </div>
            <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 20x20cm</p>
