  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "5’li Şarap Kadehi Takımı";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from mutfakk where id=11", PDO::FETCH_OBJ)->fetchAll();
    ...
    <div class="product-div">
      <div class="product-div-left">
        <div class="img-container">
          <img src="image/urunler/sarap-1.jpg" alt="5’li Şarap Kadehi Takımı">
        </div>
        <div class="hover-container">
          <div><img src="image/urunler/sarap-1.jpg" alt="5’li Şarap Kadehi Takımı"></div>
          <div><img src="image/urunler/sarap-2.jpg" alt="5’li Şarap Kadehi Takımı"></div>
          <div><img src="image/urunler/sarap-3.jpg" alt="5’li Şarap Kadehi Takımı"></div>
          <div><img src="image/urunler/sarap-4.jpg" alt="5’li Şarap Kadehi Takımı"></div>
          <div><img src="image/urunler/sarap-5.jpg" alt="5’li Şarap Kadehi Takımı"></div>
        </div>
      </div>
      <div class="product-div-right">
        <span class="product-name">5’li Sarap Kadehi Takımı</span>
        ...
        <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 8cm x 17.5cm</p>
