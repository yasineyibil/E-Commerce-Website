  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "Kandıra Keteni “Seyyah” Yastık 38x40cm";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from ipek where id=1", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/index-img-1-1-900x1200.jpg.webp" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/index-img-1-1-900x1200.jpg.webp" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm"></div>
            <div><img src="image/urunler/keten-38x40-2.jpg" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm"></div>
            <div><img src="image/urunler/keten-38x40-3.jpg" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm"></div>
            <div><img src="image/urunler/keten-38x40-4.jpg" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm"></div>
            <div><img src="image/urunler/keten-38x40-5.jpg" alt="Kandıra Keteni “Seyyah” Yastık 38x40cm"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Kandıra Keteni “Seyyah” Yastık 38x40cm</span>
          <span class="product-price" style="margin-top:40px">275 &#8378;</span>
