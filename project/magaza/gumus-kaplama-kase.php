...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  ...
  $products = $db->query("SELECT * from obje where id=12", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje12.webp" alt="Gümüş Kaplama Kase">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje12.webp" alt="Gümüş Kaplama Kase"></div>
            <div><img src="image/urunler/kaplama-kase2.jpg" alt="Gümüş Kaplama Kase"></div>
            <div><img src="image/urunler/kaplama-kase3.jpg" alt="Gümüş Kaplama Kase"></div>
            <div><img src="image/urunler/kaplama-kase4.jpg" alt="Gümüş Kaplama Kase"></div>
            <div><img src="image/urunler/kaplama-kase5.jpg" alt="Gümüş Kaplama Kase"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Gümüş Kaplama Kase</span>
          <span class="product-price" style="margin-top:40px">1200 &#8378;</span>
          <p class="product-description">İçi bakır, gümüş kaplama kase.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Zarif kulpları,</strong> bakır içi, kibar formuyla 1900’lerin başından günümüze dek yaşamış, yaşamaya devam eden; hem şık, hem çok kullanışlı, asil bir Avrupalı.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong> – Boyut:</strong> Yükseklik: 14cm, Çap: 22cm</p>
