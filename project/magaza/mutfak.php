    ...
    <div class="Item" >
          <a href=<?php echo $product->link_url; ?> class="Item__link">
            <div class="ImageContainer">
              <img src="image/urunler/<?php echo $product->img_url; ?>" alt="Christofle Balık Servis Tabağı" class="Image scroll">
              <div class="eltdf-pl-text">
                <div class="eltdf-pl-text-outer">
                  <div class="eltdf-pl-text-inner" >
                      <a href="<?php echo $product->link_url; ?>" productid="<?php echo $product->id; ?>" class="button" rel="nofollow">inceleyin</a>
                  </div>
                </div>
              </div>
            </div>
