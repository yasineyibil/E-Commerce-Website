  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "Asansörlü Kısa Pirinç Şamdan";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from obje where id=4", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje4.webp" alt="Asansörlü Kısa Pirinç Şamdan">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje4.webp" alt="Asansörlü Kısa Pirinç Şamdan"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Asansörlü Kısa Pirinç Şamdan</span>
          ...
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> Taban çapı: 13cm, Boy: 11cm </p>
