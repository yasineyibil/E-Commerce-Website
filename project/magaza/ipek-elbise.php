...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from ipek where id=4", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/ipek-elbise.jpg" alt="İpek Elbise">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/ipek-elbise.jpg" alt="İpek Elbise"></div>
            <div><img src="image/urunler/ipek-elbise2.jpg" alt="İpek Elbise"></div>
            <div><img src="image/urunler/ipek-elbise3.jpg" alt="İpek Elbise"></div>
            <div><img src="image/urunler/ipek-elbise4.jpg" alt="İpek Elbise"></div>
            <div><img src="image/urunler/ipek-elbise5.jpg" alt="İpek Elbise"></div>

          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">İpek Elbise</span>
          <span class="product-price" style="margin-top:40px">2500 &#8378;</span>
          <p class="product-description">%100 saf ipek kimono.</p>
