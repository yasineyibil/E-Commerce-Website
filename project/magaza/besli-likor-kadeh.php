  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "5’li Likör Kadehi Takımı";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from mutfakk where id=9", PDO::FETCH_OBJ)->fetchAll();
    ...
    <div class="product-div">
      <div class="product-div-left">
        <div class="img-container">
          <img src="image/urunler/likor-1.jpg" alt="5’li Likör Kadehi Takımı">
        </div>
        <div class="hover-container">
          <div><img src="image/urunler/likor-1.jpg" alt="5’li Likör Kadehi Takımı"></div>
          <div><img src="image/urunler/likor-2.jpg" alt="5’li Likör Kadehi Takımı"></div>
          <div><img src="image/urunler/likor-3.jpg" alt="5’li Likör Kadehi Takımı"></div>
          <div><img src="image/urunler/likor-4.jpg" alt="5’li Likör Kadehi Takımı"></div>
          <div><img src="image/urunler/likor-5.jpg" alt="5’li Likör Kadehi Takımı"></div>
        </div>
      </div>
      <div class="product-div-right">
        <span class="product-name">5’li Likör Kadehi Takımı</span>
        ...
        <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 5.5cm x 12.5cm</p>
