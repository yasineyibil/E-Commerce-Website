...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from ipek where id=6", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/ipek-kimono.jpg" alt="İpek Kimono">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/ipek-kimono.jpg" alt="İpek Kimono"></div>
            <div><img src="image/urunler/ipek-kimono2.jpg" alt="İpek Kimono"></div>
            <div><img src="image/urunler/ipek-kimono3.jpg" alt="İpek Kimono"></div>
            <div><img src="image/urunler/ipek-kimono4.jpg" alt="İpek Kimono"></div>
            <div><img src="image/urunler/ipek-kimono5.jpg" alt="İpek Kimono"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">İpek Kimono</span>
          <span class="product-price" style="margin-top:40px">3500 &#8378;</span>
