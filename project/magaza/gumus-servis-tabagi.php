<!-- ----------- MENU START ------------ -->
<?php
$sayfa = "Gümüş Kaplama Servis Tabağı";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from mutfakk where id=7", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/gumus-servis-tabagi.jpg" alt="Gümüş Kaplama Servis Tabağı">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/gumus-servis-tabagi.jpg" alt="Gümüş Kaplama Servis Tabağı"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Gümüş Kaplama Servis Tabağı</span>
          <span class="product-price" style="margin-top:40px">4200 &#8378;</span>
          <p class="product-description">Gümüş kaplama 3 katlı servis tabağı</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Avrupa’da</strong>
                bir otelden çıktığını düşündüğümüz, 1950’li yıllardan üç katlı zarif meyve servisi tabağı.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> Tabaklar: Yükseklik: 46cm, Taban çapı: 27cm</p>
