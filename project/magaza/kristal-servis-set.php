<?php
$sayfa = "Kristal & Gümüş Kaplama Servis Seti";
...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  ...
  <?php
    ...
    $products = $db->query("SELECT * from mutfakk where id=3", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/kristal-servis-set.jpg" alt="Kristal & Gümüş Kaplama Servis Seti">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/kristal-servis-set.jpg" alt="Kristal & Gümüş Kaplama Servis Seti"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Kristal & Gümüş Kaplama Servis Seti</span>
          <span class="product-price" style="margin-top:40px">4500 &#8378;</span>
          <p class="product-description">4lü kristal servis tabağı & gümüş kaplama tepsi.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Özellikle kahvaltı</strong> servisine uygun, 4lü kristal set & gümüş kaplama tepsi takımı.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 37x37cm</p>
          <p class="product-description" style="margin-top:-10px;">– Gümüş kaplama & kristal</p>
