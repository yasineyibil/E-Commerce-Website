...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from ipek where id=3", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/bluz.jpg" alt="Uzun Kollu İpek Bluz">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/bluz.jpg" alt="Uzun Kollu İpek Bluz"></div>
            <div><img src="image/urunler/bluz2.jpg" alt="Uzun Kollu İpek Bluz"></div>
            <div><img src="image/urunler/bluz3.jpg" alt="Uzun Kollu İpek Bluz"></div>
            <div><img src="image/urunler/bluz4.jpg" alt="Uzun Kollu İpek Bluz"></div>
            <div><img src="image/urunler/bluz5.jpg" alt="Uzun Kollu İpek Bluz"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Uzun Kollu İpek Bluz</span>
          <span class="product-price" style="margin-top:40px">1450 &#8378;</span>
