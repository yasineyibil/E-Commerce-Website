...
<?php
    ...
    include "../lib/tdb.php";
    $id=$_GET['id'];
    $resim="../../Antique-Rach/image/magaza-img/";
    $sorgu=$db->prepare("select * from tmagaza_img where id=:id");
        ...
        $guncellesorgu=$db->prepare($sql);
         ...
         if(@$guncelle){
            echo "<script> Swal.fire( { title:'Başarılı!', text:'Başarıyla Güncellediniz.', icon:'success', confirmButtonText:'Kapat' }).then((value)=>{
                if(value.isConfirmed){window.location.href='tmagaza_img.php'}})</script>";
        }
            ...
            <div class="card mb-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="margin-top:15px;">
                            <img src="../../Antique-Rach/image/magaza-img/<?= $sonuc["img_url"]?>" width="200"><br>
