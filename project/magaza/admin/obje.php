                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="objeekle.php" class="btn btn-primary">Obje Ekle</a>
                            </div>
                            <div class="card-body">
                                <table  id="datatablesSimple" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sorgu=$db->prepare("select * from obje");
                                            $sorgu->execute();
                                            ...
                                            <tr>
                                                ...
                                                <td width="60" class="text-center"><a href="objeguncelle.php?id=<?= $sonuc["id"]?>">
                                                    <span class="fa fa-edit"></span>
                                                </a></td>
                                                <td width="60" class="text-center">
                                                    <a href="sil.php?id=<?= $sonuc["id"] ?>&tablo=obje">
