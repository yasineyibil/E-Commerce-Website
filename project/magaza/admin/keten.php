    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <a href="ketenekle.php" class="btn btn-primary">Keten Ekle</a>
            </div>
            <div class="card-body">
                <table id="datatablesSimple" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        $sorgu = $db->prepare("select * from keten");
                        $sorgu->execute();
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="60" class="text-center"><a href="ketenguncelle.php?id=<?= $sonuc["id"] ?>">
