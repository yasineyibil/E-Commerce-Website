                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="ipekekle.php" class="btn btn-primary">İpek Ekle</a>
                            </div>
                            <div class="card-body">
                                <table  id="datatablesSimple" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        <?php // foreach ($products as $product){
                                            ...
                                            $sorgu=$db->prepare("select * from ipek");
                                            $sorgu->execute();
                                            ...
                                            <tr>
                                                ...
                                                <td width="60" class="text-center"><a href="ipekguncelle.php?id=<?= $sonuc["id"]?>">
                                                    <span class="fa fa-edit"></span>
                                                </a></td>
                                                <td width="60" class="text-center">
                                                    <a href="sil.php?id=<?= $sonuc["id"] ?>&tablo=ipek">
