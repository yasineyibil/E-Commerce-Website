                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="tatolyeekle.php" class="btn btn-primary">Atölye Ekle</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php // foreach ($products as $product){
                                            ...
                                            <tr>
                                                ...
                                                <td width="60" class="text-center"><a href="tatolyeguncelle.php?id=<?= $sonuc["id"]?>">
                                                    <span class="fa fa-edit"></span>
                                                </a></td>
                                                <td width="60" class="text-center">
                                                    <a href="tsil.php?id=<?= $sonuc["id"] ?>&tablo=tatolye">
