                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="tdepoekle.php" class="btn btn-primary">Depo Ekle</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php // foreach ($products as $product){
                                            ...
                                            <tr>
                                                ...
                                                <td width="700"><?= $sonuc["txt"]?></td>
                                                <td width="300"><?= $sonuc["bold_txt2"]?></td>
                                                <td width="60" class="text-center"><a href="tdepoguncelle.php?id=<?= $sonuc["id"]?>">
                                                    <span class="fa fa-edit"></span>
                                                </a></td>
                                                <td width="60" class="text-center">
                                                    <a href="tsil.php?id=<?= $sonuc["id"] ?>&tablo=tdepo">
