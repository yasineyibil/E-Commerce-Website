...
<?php
    $sayfa="Depo Resim Güncelle";
    include "inc/ahead.php";


    include "../lib/tdb.php";
    $id=$_GET['id'];
    $resim="../../Antique-Rach/image/depo-img/";
    $sorgu=$db->prepare("select * from tdepo_img where id=:id");
        ...
        $guncellesorgu=$db->prepare($sql);
         ...
         if(@$guncelle){
            echo "<script> Swal.fire( { title:'Başarılı!', text:'Başarıyla Güncellediniz.', icon:'success', confirmButtonText:'Kapat' }).then((value)=>{
                if(value.isConfirmed){window.location.href='tdepo_img.php'}})</script>";
        }
            ...
            <div class="card mb-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="margin-top:15px;">
                            <img src="../../Antique-Rach/image/depo-img/<?= $sonuc["img_url"]?>" width="200"><br>
