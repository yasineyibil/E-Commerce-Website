...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from obje where id=1", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje1.webp" alt="Ahşap Sebze Tartısı">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje1.webp" alt="Ahşap Sebze Tartısı"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Ahsap Sebze Tartısı</span>
          <span class="product-price" style="margin-top:40px">3000 &#8378;</span>
          <p class="product-description">Ahsap sebze tartısı.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Yaklaşık</strong> 100 yaşında, Fransız ahşap sebze tartısı.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> 48x15cm </p>
