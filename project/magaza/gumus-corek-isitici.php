  <!-- ----------- MENU START ------------ -->
  <?php
  $sayfa = "Gümüş Kaplama Çörek Isıtıcısı";
  ...
  <div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
    ...
    $products = $db->query("SELECT * from mutfakk where id=6", PDO::FETCH_OBJ)->fetchAll();
        ...
        <div class="product-div">
          <div class="product-div-left">
            <div class="img-container">
              <img src="image/urunler/gumus-corek-isitici-1.jpg" alt="Gümüş Kaplama Çörek Isıtıcısı">
            </div>
            <div class="hover-container">
              <div><img src="image/urunler/gumus-corek-isitici-1.jpg" alt="Gümüş Kaplama Çörek Isıtıcısı"></div>
              <div><img src="image/urunler/gumus-corek-isitici-2.jpg" alt="Gümüş Kaplama Çörek Isıtıcısı"></div>
            </div>
          </div>
          <div class="product-div-right">
            <span class="product-name">Gümüş Kaplama Çörek Isıtıcısı</span>
            <span class="product-price" style="margin-top:40px">2500 &#8378;</span>
            <p class="product-description">Gümüş kaplama çörek ısıtıcısı.</p>
            ...
            <div class="sag-sol">
              ...
              <div class="sag">
                <p>
                  <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">Bir zamanların</strong>
                  sofra adabını anımsatan zarif bir parça. İngiliz, yaklaşık 60 yaşlarında. Kahvaltı sofrasına koyup, içine çöreğinizi, ekmeğinizi koyup sıcak kalmalarını sağlayabilirsiniz. Dilerseniz açık şekilde servis tabağı olarak da kullanabilirsiniz.
                </p>
              </div>
            </div>
            <p class="product-description" style="margin-top:40px"><strong>– Boyut:</strong> Tabaklar: Yükseklik: 29cm, En: 23cm</p>
