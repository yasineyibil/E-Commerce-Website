...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from keten where id=9", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/keten.jpg" alt="Kandıra Keteni “Seyyah” Yastık 80x40cm">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/keten.jpg" alt="Kandıra Keteni “Seyyah” Yastık 80x40cm"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Kandıra Keten Yastık</span>
          <span class="product-price" style="margin-top:40px">195 &#8378;</span>
