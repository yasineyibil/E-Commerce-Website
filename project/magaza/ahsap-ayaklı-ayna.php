...
<div class="main-wrapper" style="margin-top:193px; margin-bottom:50px;">
  <?php
    ...
    $products = $db->query("SELECT * from obje where id=3", PDO::FETCH_OBJ)->fetchAll();
      ...
      <div class="product-div">
        <div class="product-div-left">
          <div class="img-container">
            <img src="image/urunler/obje3.webp" alt="Ahşap Ayaklı Ayna">
          </div>
          <div class="hover-container">
            <div><img src="image/urunler/obje3.webp" alt="Ahşap Ayaklı Ayna"></div>
          </div>
        </div>
        <div class="product-div-right">
          <span class="product-name">Ahsap Ayaklı Ayna</span>
          <span class="product-price" style="margin-top:40px">1500 &#8378;</span>
          <p class="product-description">Thonet tarzı ahsap ayaklı ayna.</p>
          ...
          <div class="sag-sol">
            ...
            <div class="sag">
              <p>
                <strong style="font-family:'content'; font-size:20px; font-weight:500; font-style: italic;">“Aynadaki aksim, gölgem, bir de ben.”</strong>
                Aklımızda bu Cahit Sıtkı Tarancı dizeleri, bu aynanın güzelliğine saygı duruyoruz. Thonet tarzı, 1930lardan kalma, ayaklı bir konsol aynası. Güzel yaşamış, bizce çok da güzel yaşlanmış.
              </p>
            </div>
          </div>
          <p class="product-description" style="margin-top:40px"><strong>– Çap:</strong> 23cm,<strong> Yükseklik:</strong> 50cm.</p>
          <p class="product-description" style="margin-top:-10px;">– Ahşap.</p>
